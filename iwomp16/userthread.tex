...
A user thread could become an OpenMP initial thread that creates OpenMP {\sf parallel} region, 
 or beneath the OpenMP threading runtime when an OpenMP thread spawns 
