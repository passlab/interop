...
%. omposability are closely related, while the interoperability sounds to improve the interactions between multiple models
...
%do not interoperate well with either incluing oversubscription and memory affinity confliction. We then propose language 
%extensions to OpenMP to address the interoperability challengs of parallel programming. 
\begin{comment}
...
We think the similar challenges exist in other threading based libraries and language implementations, and believe
the solutions we provided  will work for them too.  
