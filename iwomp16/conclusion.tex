In this paper, we have explored use cases for OpenMP to interact other parallel programming models
...
some of the initial performance results and efforts for the implementation. % with initial results for 
