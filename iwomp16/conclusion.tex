...
We will investigate to address thread affinity conflict issue and other interoperability challenges. % explore challenges of using multiple instances of OpenMP runtimes.
