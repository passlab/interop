...
doing any OpenMP operation, e.g. during the sequential execution of the program. 
...
\cline{2-4}      & {SUSPEND} & Thread sleeps. Others wake it up. & mutex\_wait(); mutex\_wake(); \\
\cline{2-4}      & {TERMINATE} & Thread terminates. &  pthread\_exit();\\
\hline
\end{tabular}%
}
