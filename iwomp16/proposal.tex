...
%		It is released from the barrier to participate in a team for computation by the runtime. 
	...
	\item {\bf TRIGGER}: The thread is putting to SLEEP state such that it is completely suspended. A sleeping
		thread resumes upon some hardware state change.\footnote{
                    ...
                    Other processors may have similar features.}
