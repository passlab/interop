...
This interoperability proposal attempts to address the oversubscription challenges by providing more information or control
...
\end{lstlisting}
The {\sf omp\_set\_dynamic} is already in the standard. The {\sf void omp\_set\_wait\_policy (omp\_thread\_state\_t)} API
sets the wait-policy-var
