The evaluation was performed on a machine using two Intel(R) Xeon(R) E5-2699 processors with total 36 cores supporting 72 threads. We use the latest
...
Figure~\ref{omp:quiesce_evaluation} shows the design of the evaluation. 
...
The cost of shutdowning a runtime is about half of the cost of starting a runtime, but about 4 to 10 times of the cost of parallel region creation. 
