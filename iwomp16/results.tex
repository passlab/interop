The evaluation was performed on a machine using two Intel\regtm Haswell-EP Xeon\regtm E5-2699v3 processors with total 36 cores supporting 72 threads. We use the latest
